 ...
 * PA0 = I1  — фазный ток A (FOC Clarke), шунт 0.03 Ом + ОУ 2.1х, смещение 1.65В
 * PA1 = I2  — фазный ток B (FOC Clarke), шунт 0.03 Ом + ОУ 2.1х, смещение 1.65В
 * PA6 = Ires — остаточный ток (трансформаторный датчик A+B+C), диагностический канал
