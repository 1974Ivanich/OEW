...
- [docs/TEST2_SIMPLE_CHECKLIST.md](docs/TEST2_SIMPLE_CHECKLIST.md) — упрощённый одностраничный checklist Test № 2 без Test № 3 migration/G0/sigrok.
- [docs/TEST2_SIMPLE_REPORT_TEMPLATE.md](docs/TEST2_SIMPLE_REPORT_TEMPLATE.md) — минимальный шаблон отчёта Test № 2 и фиксации UART/DMM evidence.
