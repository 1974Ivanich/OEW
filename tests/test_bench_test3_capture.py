"""Offline tests for tools/bench_test3_capture.py; no COM port or sigrok device."""
...
def evaluate(status_text: str, drain_text: str = DRAIN_ZERO,
    ...
    return capture.evaluate_test(
        ...
        status_text,
        drain_text,
        profile_contract=capture.get_profile_contract(capture.APPROVED_TEST3_PROFILE_ID),
    )
...
class CaptureParserTest(unittest.TestCase):
    ...
    def test_profile_contract_is_read_only(self) -> None:
        contract = capture.get_profile_contract(capture.APPROVED_TEST3_PROFILE_ID)
    ...
    def test_default_capture_warmup_fits_fx2lafw_window(self) -> None:
        ...
        # (TZ_BENCH_TEST3_SIGROK_WARMUP.md).
