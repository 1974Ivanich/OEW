...
SCRIPT_PATH = REPO / "tools" / "bench_test3_campaign_archive.py"
SPEC = importlib.util.spec_from_file_location("bench_test3_campaign_archive", SCRIPT_PATH)
...
def write_campaign(tmp_path: Path, name: str = "test3_nohv_20260825T120000Z") -> Path:
    campaign = tmp_path / name
    campaign.mkdir()
    write_json(campaign / "g0_approval.json", {
        "gate": "HIL_TEST3_G0", "decision": "APPROVED", "approval_id": "G0-001",
    })
