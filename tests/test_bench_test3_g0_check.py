...
SCRIPT_PATH = REPO / "tools" / "bench_test3_g0_check.py"
SPEC = importlib.util.spec_from_file_location("bench_test3_g0_check", SCRIPT_PATH)
...
def test_valid_campaign_passes_and_is_explicitly_offline(tmp_path: Path) -> None:
    ...
    assert summary["gate"] == "HIL_TEST3_G0"
