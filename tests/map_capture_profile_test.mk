...
map-capture-board-profile-test:
	$(CC) $(CFLAGS) -I./src -DOEW_MAP_CAPTURE=1 -DOEW_MAP_L3=1 src/map_capture_profiles.c tests/map_capture_board_profile_test.c -o tests/map_capture_board_profile_test.exe
