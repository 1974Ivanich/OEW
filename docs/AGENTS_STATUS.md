...
| ai-bench (стенд) | ПК-1 | ai-bench/ct-fix | ТЗ CT-канал/калибровка: e73b8f0 + честный FAIL; no-HV сессия ПОЛНОСТЬЮ PASS: ADC (I1~2040/I2~2068/VBUS 598 raw), ENC err=0, offset_i1=2039, фантомы 26А→0, FAULT=0, FOC rc=-2, soak 60с, CLI robustness (11 кейсов), UART stress 50/50, конфиг-команды без energise, финальная проверка 8/8 | src/adc.c/h, src/cli.c | готово к приёмке (CI на ubuntu) |
