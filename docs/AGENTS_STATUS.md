...
|---|---|---|---|---|---|
| ai2 (Hermes) | ПК-2 | ai2/emstop-telemetry | Телеметрия EM_STOP1/2 (PB12/PD2): периодика @FOC/@VF + @FAULT:CLEAR:STATUS | main.c, src/cli.*, src/pwm_board_pins.*, tests/cli_test.c | готово, ждёт приёмки |
