...
| ai4 (Manus) | ПК-1 | ai4/bench-test2-campaign-archive | ТЗ post-campaign archive: fail-closed inventory, SHA-256 manifest и deterministic ZIP для evidence physical Test №2; offline only | TZ_BENCH_TEST2_CAMPAIGN_ARCHIVE.md, tools/bench_test2_campaign_archive.py/.md, tests/test_bench_test2_campaign_archive.py, README.md, docs/AGENTS_STATUS.md | make + make test PASS (110 pytest); flash намеренно не запускался; готово к CI-приёмке, не обращалось к hardware |
