...
Отдельно от TZ-02 должна быть закрыта обнаруженная в audit atomicity-проблема replacement path: невалидная замена не должна очищать ранее действующую валидную карту.
